...
class LocalizedLicenseController extends Controller
{
    ...
    public function chooseLicenseMode(Request $request)
    {
        ...
        if ($chose) {
            ...
            return response()->json(['success' => trans('message.status_change_successfully')]); //return redirect()->back()->with('success', trans('Private and Public Keys generated for this order number: '.$orderNo));
        } else {
            ...
            return response()->json(['success' => trans('message.status_change_successfully')]); //return redirect()->back()->with('success',trans('Reverted back to database license mode' .$orderNo));
        }
    }
    ...
    /*public function fileEdit(Request $request,$fileName)
    {
      ...
      $handle=@fopen($stored, "w+");
       ...
       @fclose($handle);
       return redirect()->back()->with('success', trans('License data is updated'.$orderNo));
    }*/
    ...
    public function deleteFile($fileName)
    {
        ...
        return redirect()->back()->with('success', trans('message.license_file_deleted', ['file' => $fileName]));
    }
