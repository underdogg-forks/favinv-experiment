...
@section('title')
 {{ trans('message.script') }}
@stop
@section('content-header')
    <div class="col-sm-6">
        <h1>{{ trans('message.create_script_code')}}</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{url('chat')}}"><i class="fa fa-dashboard"></i> {{ trans('message.script')}}</a></li>
            <li class="breadcrumb-item active">{{ trans('message.create_script')}}</li>
        </ol>
    </div><!-- /.col -->
@stop
@section('content')
                ...
                <div class="row">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6 form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                        <!-- first name -->
                        {!! html()->label( trans('message.show_script'), 'script')->class('required') !!}
                        <br>
                        {!! html()->radio('on_registration', 1)->checked() !!}
                        <label for="on_registration" style="font-weight: normal !important;">{{ trans('message.on_registration') }}</label>
                        &nbsp;{!! html()->radio('on_registration', 0) !!}
                        <label for="on_every_page" style="font-weight: normal !important;">{{ trans('message.on_every_page') }}</label>
                     ...
                     <div class="col-md-3 form-group">
                        <!-- first name -->
                         ...
                         {!! html()->label( trans('message.google_analytics'), 'analytics') !!}
                    ...
                    <div class="col-md-3 form-group analytics_tag" hidden>
                        {!! html()->label( trans('message.chat_google_analytics_tag'), 'tag')->class('required') !!}
