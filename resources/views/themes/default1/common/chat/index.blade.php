...
@section('title')
    {{ trans('message.create_script') }}
@stop
@section('content-header')
    <div class="col-sm-6">
        <h1>{{ trans('message.google_analytics_javascript')}}</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{ trans('message.script')}}</li>
        </ol>
    </div><!-- /.col -->
@stop
...
<div class="card card-secondary card-outline">
    <div class="card-header">
        <h3 class="card-title">{{ trans('message.chat')}}</h3>

        <div class="card-tools">
            <a href="{{url('chat/create')}}" class="btn btn-default btn-sm pull-right"><span class="fa fa-plus"></span>&nbsp;&nbsp;{{trans('message.create')}}</a></h4>
         ...
         if(id.length <=0){
             swal.fire({
                 ...
                 html: "<div class='swal2-html-container custom-content'>" +
                     ...
                     "<p>{{trans('message.sweet_script')}}</p>" + "</div>" +
                     "</div>",
                 position: 'top',
             ...
             var swl = swal.fire({
                 ...
                 html: "<div  class='swal2-html-container custom-content'>" +
                     "<div class='section-sa'>" +
                     "<p>{{trans('message.script_delete')}}</p>" + "</div>" +
                     "</div>",
