...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" id="defaultModalLabel">{{ trans('message.enter_update_expiry_date') }}</h4>
      ...
      <div id="error2"></div>
		  ...
		  <div class="form-group">
                    <!-- name -->
              {!! html()->label(trans('message.update_end'), 'updates')->class('required') !!}
		  ...
		  <div class="modal-footer justify-content-between">
                ...
                <button type="submit" id="updatesSave" class="btn btn-primary"><i class="fas fa-save"></i>&nbsp;{{ trans('message.save') }}</button>
            </div>
	</div>
</div>
</div>
