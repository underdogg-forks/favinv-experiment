...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" id="defaultModalLabel">{{ trans('message.enter_license_expiry') }}</h4>
      ...
      <div id="error3"></div>
		  ...
		  <div class="modal-footer justify-content-between">
                ...
                <button type="submit" id="supportExpSave" class="btn btn-primary"><i class="fas fa-save"></i>&nbsp;{{ trans('message.save') }}</button>
            </div>
	</div>
</div>
</div>
