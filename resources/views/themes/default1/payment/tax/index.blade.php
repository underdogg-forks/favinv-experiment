...
@section('content-header')
    <div class="col-sm-6">
        <h1>{{ trans('message.create_tax_option_class') }}</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{ trans('message.tax') }}</li>
        </ol>
    </div><!-- /.col -->
@stop
                    ...
                    <table class="table">
                            ...
                            <td>
                                ...
                                <div class="btn-group btn-group-toggle"  data-toggle="buttons" >
                                    ...
                                    <input type="radio" id="chkYes" value="1" name="tax_enable" >{{ trans('message.caps_enabled') }}</label>
                                    <label class="btn btn-default btn-off-1 btn-sm  ">
                                    <input type="radio" id="chkNo" value="0" name="tax_enable" >{{ trans('message.caps_disabled') }}</label>
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <input type="radio" id="chkYes" value="1" name="inclusive">{{ trans('message.caps_inclusive') }}</label>
                                    <label class="btn btn-default btn-off-2 btn-sm">
                                    <input type="radio" id="chkNo" value="0" name="inclusive">{{ trans('message.caps_exclusive') }}</label>
                                    <span class="slider"></span>
                                  </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <input type="radio" id="chkYes" value="1" name="rounding">{{ trans('message.caps_enabled') }}</label>
                                    <label class="btn btn-default btn-off-3 btn-sm">
                                    <input type="radio" id="chkNo" value="0" name="rounding">{{ trans('message.caps_disabled') }}</label>
                                    <span class="slider"></span>
                                  </div>                            </td>
                        </tr>
