...
@section('content-header')
    <div class="col-sm-6">
        <h1>{{ trans('message.product_groups') }}</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="fa fa-dashboard"></i> {{ trans('message.home') }}</a></li>
            <li class="breadcrumb-item active">{{ trans('message.product_groups') }}</li>
        </ol>
    </div><!-- /.col -->
@stop
...
<div class="card card-secondary card-outline">
    ...
    <div class="card-header">
        <h3 class="card-title">{{trans('message.groups')}}</h3>

        <div class="card-tools">
            <a href="{{url('groups/create')}}" class="btn btn-default btn-sm pull-right"><span class="fa fa-plus"></span>&nbsp;&nbsp;{{trans('message.create')}}</a>
         ...
         if(id.length<=0){
             swal.fire({
                 ...
                 html: "<div class='swal2-html-container custom-content'>" +
                     ...
                     "<p>{{trans('message.sweet_group')}}</p>" + "</div>" +
                     "</div>",
                 position: 'top',
             ...
             var swl = swal.fire({
                 ...
                 html: "<div class='swal2-html-container custom-content'>" +
                     "<div class='section-sa'>" +
                     "<p>{{trans('message.group_delete')}}</p>" + "</div>" +
                     "</div>",
