...
@endif
    <li class="active text-dark">{{ trans('message.stripe')}}</li>
@stop
 ...
 <div class="container py-4">
    ...
    <div class="card border-width-3 border-radius-0 border-color-hover-dark mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="font-weight-bold text-uppercase text-4 mb-3">{{ trans('message.your_order_confirmation')}}</h4>
                            ...
                            <table class="shop_table cart-totals mb-0">
                               ...
                               <tr class="cart-subtotal">
                                    <td class="border-top-0">
                                        <strong class="text-color-dark">{{ trans('message.sub_total')}}</strong>
                                    </td>
                                ...
                                <tr class="total">
                                    ...
                                    <td class="text-end">
                                       ...
                                       <strong class="d-block text-color-dark line-height-1 font-weight-bold"><span class="amount text-color-dark text-3">{{ trans('message.paid_with')}}
                                          @if($cardBrandIcon)
                        ...
                        <div class="col-lg-8">
                            ...
                            <form id="stripeConfirmForm" action="{{ url('final/stripe') }}" method="POST">
                                ...
                                <button type="submit" class="btn btn-dark btn-modern w-50 text-uppercase text-3 py-3">
                                    {{ trans('message.finish')}} <i class="fas fa-arrow-right ms-2"></i>
                                </button>
                            </form>
                        </div>
                    </div>
