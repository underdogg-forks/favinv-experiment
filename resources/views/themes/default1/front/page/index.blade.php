...
@section('title')
{{ trans('message.all_pages') }}
@stop
@section('content-header')
    <div class="col-sm-6">
        <h1>{{ trans('message.all_pages')}}</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="fa fa-dashboard"></i> {{ trans('message.home')}}</a></li>
            <li class="breadcrumb-item active">{{ trans('message.all_pages')}}</li>
        </ol>
    </div><!-- /.col -->
@stop
@section('content')
    ...
    <div class="card card-secondary card-outline">
        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{url('pages/create')}}" class="btn btn-default btn-sm pull-right" <?php if($pages_count >= 3)  {?>  onclick="return false" title="{{ trans('message.page_limit')}}"  <?php  }?> ><span class="fas fa-plus"></span>&nbsp;{{trans('message.create')}}</a>
