...
@section('title')
{{ trans('message.widgets') }}
@stop
@section('content-header')
    <div class="col-sm-6">
        <h1>{{ trans('message.all_widgets')}}</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{ trans('message.widgets')}}</li>
        </ol>
    </div><!-- /.col -->
@stop
@section('content')
        ...
        <h3 class="card-title">{{trans('message.widgets')}}</h3>
         ...
         @if($widgetsCount < 3)
            <div class="card-tools">
                <a href="{{url('widgets/create')}}" class="btn btn-default btn-sm pull-right"><span class="fa fa-plus"></span>&nbsp;&nbsp;{{trans('message.create')}}</a>
         ...
         if(id.length<=0){
             swal.fire({
                 ...
                 html: "<div class='swal2-html-container custom-content'>" +
                     ...
                     "<p>{{trans('message.sweet_widget')}}</p>" + "</div>" +
                     "</div>",
                 position: 'top',
             ...
             var swl = swal.fire({
                 ...
                 html: "<div class='swal2-html-container custom-content'>" +
                     "<div class='section-sa'>" +
                     "<p>{{trans('message.widget_delete')}}</p>" + "</div>" +
                     "</div>",
