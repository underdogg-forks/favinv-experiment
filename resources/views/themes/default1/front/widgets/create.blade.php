...
@section('title')
 {{ trans('message.create_widget') }}
@stop
@section('content-header')
    <div class="col-sm-6">
        <h1>{{ trans('message.create_new_widget') }}</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{ trans('message.create_widget')}}</li>
        </ol>
    </div><!-- /.col -->
@stop
@section('content')
<div class="card card-secondary card-outline">
    ...
    {!! html()->form('POST', url('widgets'))->id('widgetForm')->open() !!}
                ...
                ?>
                   ...
                   <div class="col-md-4 form-group {{ $errors->has('allow_mailchimp') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-4 form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                        ...
                        {!! html()->select('type', ['' => trans('message.choose'), 'footer1' => 'Footer 1', 'footer2' => 'Footer 2', 'footer3' => 'Footer 3'])->class('form-control'. ($errors->has('type') ? ' is-invalid' : ''))->id('type') !!}
                        @error('type')
                        <span class="error-message"> {{$message}}</span>
                        @enderror
                        <div class="input-group-append">
