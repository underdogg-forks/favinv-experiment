                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border-width-3 border-radius-0 border-color-success">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="text-color-dark font-weight-bold text-4-5 mb-0"><i class="fas fa-check text-color-success me-1"></i> {{ trans('message.thanks_order_received')}}</p>
                        </div>
                    </div>
                 ...
                 <div class="d-flex flex-column flex-md-row justify-content-between py-3 px-4 my-4">
                        ...
                        <div class="text-center">
                            <span><strong class="text-color-dark">
                                {{ trans('message.invoice_number')}} </strong><br>
                                {{$invoice->number}}
                            </span>
                        </div>
                        ...
                        <div class="text-center mt-4 mt-md-0">
                            <span><strong class="text-color-dark">
                                {{ trans('message.status')}}</strong> <br>
                                {{ trans('message.success')}}
                            </span>
                        </div>
                        <div class="text-center mt-4 mt-md-0">
                            <span><strong class="text-color-dark">
                                {{ trans('message.date')}}</strong> <br>
                                {!! $date !!}
                            </span>
                        </div>
                        <div class="text-center mt-4 mt-md-0">
                            <span><strong class="text-color-dark">
                                {{ trans('message.payment-method')}}</strong> <br>
                            ...
                            <table class="shop_table cart-totals mb-0">
                                ...
                                <tr>
                                    <td colspan="2" class="border-top-0">
                                        <strong class="text-color-dark">{{ trans('message.product')}}</strong>
                                ...
                                <tr>
                                   <td>
                                    ...
                                    <ul class="wc-item-meta" style="list-style: none; padding: 0;">
                                        <li style="display: inline-block;"><strong class="wc-item-meta-label">{{ trans('message.order_number')}}:</strong> <p style="display: inline;">{{$order->number}}</p></li>
                                    </ul> 
                                </td>
                                    ...
                                    <td class="text-end align-top">
                                        ...
                                        @if($downloadPermission['downloadPermission'] == 1 && !in_array($product->id,cloudPopupProducts()))
                                            ...
                                            <a href="{{ url("product/download/$order->product/$invoice->number") }}" class="btn btn-light-scale-2 btn-sm text-dark" data-toggle="tooltip" aria-label="{{ trans('message.click_to_download')}}" data-bs-original-title="{{ trans('message.click_to_download')}}"><i class="fa fa-download"> </i></a>
