...
@section('breadcrumb')
    ...
    @endif
    <li class="active text-dark">{{ trans('message.order_details')}}</li>
@stop
...
@section('content')
            ...
            <div class="col-lg-12 alert bg-color-light-scale-2">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between plan-features">
                    ...
                    <div class="text-center">
                            <span>
                                <strong>{{ trans('message.order_number')}}</strong> <br>
                                #{{$order->number}}
                            </span>
                    </div>
                    <div class="text-center mt-4 mt-md-0">
                            <span>
                                <strong>{{ trans('message.date')}}</strong> <br>
                                {!! getDateHtml($order->created_at) !!}
                            </span>
                    </div>
                    <div class="text-center mt-4 mt-md-0">
                            <span>
                                <strong>{{ trans('message.status')}}</strong><br>
                                {{$order->order_status}}
                            </span>
                    </div>
                    <div class="text-center mt-4 mt-md-0">
                            <span>
                                <strong>{{ trans('message.expiry_date')}}</strong><br>
                        ...
                        <div class="modal-body">
                            <form method="GET" action="{{url('uploadFile')}}">
                                ...
                                <div class="form-group">
                                    <label for="recipient-name" class="col-form-label">{{ trans('message.domain_name')}}</label>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" id="close" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i>&nbsp;{{ trans('message.close')}}</button>
                                        @if((!Storage::disk('public')->exists('faveo-license-{'.$order->number.'}.txt')) || $order->is_downloadable==0)
                                            <button type="submit" id="domainSave" class="done btn btn-primary" {{$order->where('number',$order->number)->update(['is_downloadable'=> 1])}}><i class="fas fa-save"></i>&nbsp;{{ trans('message.done')}}</button>
                                        @endif
                                    </div>
                                </div>
                            </form>
                    ...
                    <ul class="nav nav-list flex-column">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link active" href="#license" data-bs-toggle="tab" data-hash data-hash-offset="0"
                               data-hash-offset-lg="500" data-hash-delay="500">{{ trans('message.license_details')}}
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="#users" data-bs-toggle="tab" data-hash data-hash-offset="0"
                               data-hash-offset-lg="500" data-hash-delay="500">{{ trans('message.user_details')}}
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="#invoice" data-bs-toggle="tab" data-hash data-hash-offset="0"
                               data-hash-offset-lg="500" data-hash-delay="500">{{ trans('message.invoice_list')}}
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="#receipt" data-bs-toggle="tab" data-hash data-hash-offset="0"
                               data-hash-offset-lg="500" data-hash-delay="500">{{ trans('message.payment_receipts')}}
                            </a>
                        </li>
                        @if(in_array($product->id,cloudPopupProducts()) && $order->order_status!='Terminated')
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link" href="#cloud" data-bs-toggle="tab" data-hash data-hash-offset="0"
                                   data-hash-offset-lg="500" data-hash-delay="500">{{ trans('message.cloud_settings')}}
                                </a>
                            </li>
                        @endif
                        ...
                        @if($price == '0' && !in_array($product->id,cloudPopupProducts()) && $order->order_status!='Terminated')
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link" href="#auto-renew" data-bs-toggle="tab" data-hash data-hash-offset="0"
                                   data-hash-offset-lg="500" data-hash-delay="500">{{ trans('message.auto_renewal')}}
                                </a>
                            </li>
            ...
            <div class="col-lg-9 mt-2">
                @if($order->order_status != 'Terminated')
                    @if(!empty($terminatedOrderId))
                        <p class="order-links">
                            {{ trans('message.order')}}: <b>{{$order->number}}</b>
                            {{ trans('message.has_been_generated')}} <a class="order-link" href="{{$terminatedOrderId}}">{{$terminatedOrderNumber}}</a> {{ trans('message.was_terminated')}}
                        </p>
                    @endif
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <div class="pe-3 pe-sm-5 pb-3 pb-sm-0 border-right-light">
                                            ...
                                            <span class="mb-2 font-weight-bold">{{ trans('message.license_code')}}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <a href="#" class="btn btn-light-scale-2 text-black btn-sm ms-4" id="copyButton" data-bs-toggle="tooltip" title="{{ trans('message.copy') }}">
                                            <i class="fas fa-copy"></i>
                                        </a>

                                        <span id="copiedMessage" class="hidden">{{ trans('message.copied')}}</span>

                                        @if ($licenseStatus == 1)
                                            @if(!in_array($product->id,cloudPopupProducts()) && $price != '0')

                                                <a class="btn btn-light-scale-2 btn-sm text-black btn-sm" data-bs-toggle="tooltip" title="{{ trans('message.reissue_license') }}" id="reissueLic" data-id="{{$order->id}}" data-name="{{$order->domain}}" {{!Storage::disk('public')->exists('faveo-license-{'.$order->number.'}.txt') || $order->license_mode!='File' ? "enabled" : "disabled"}}>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <div class="pe-3 pe-sm-5 pb-3 pb-sm-0 border-right-light">
                                            ...
                                            <span class="mb-2 font-weight-bold">{{ trans('message.license_expiry_date')}}</span>
                                        </div>
                                    </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <div class="pe-3 pe-sm-5 pb-3 pb-sm-0 border-right-light">
                                            ...
                                            <span class="mb-2 font-weight-bold">{{ trans('message.update_expiry_date')}}</span>
                                        </div>
                                    </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <div class="pe-3 pe-sm-5 pb-3 pb-sm-0 border-right-light">
                                            ...
                                            <span class="mb-2 font-weight-bold">{{ trans('message.localized_license')}}</span>
                                        </div>
                                    </div>

                                    <div class="col-sm-7">

                                     <button class="btn btn-dark mb-2 btn-sm" id="defaultModalLabel" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" {{!Storage::disk('public')->exists('faveo-license-{'.$order->number.'}.txt') || $order->is_downloadable==0 ? "enabled" : "disabled"}}>{{ trans('message.download_license_file')}}</button>
                                     <a href="{{url('downloadPrivate/'.$order->number)}}"><button class="btn btn-dark mb-2 btn-sm" onclick="refreshPage()">{{ trans('message.download_license_key')}}</button></a>
                                     <i class="fa fa-info ml-2" data-bs-toggle="tooltip" title="{{ trans('message.license_mandatory')}}" >{!!tooltip('Edit')!!}</i>
                  ...
                  <div class="tab-pane tab-pane-navigation active" id="license" role="tabpanel">
                        ...
                        @foreach($newOrders as $newOrder)
                            <div class="termination-message">
                                <p class="termination-notice"><b>{{ trans('message.imp_termination_notice')}}</b></p>
                                <p class="termination-description">
                                    {{ trans('message.order_msg')}}
                                </p>
                                <p class="order-links">
                                    {{ trans('message.termination_order')}} <b>{{$order->number}}</b>
                                    {{ trans('message.upgrade_new_order')}} <a class="order-link" href="{{$newOrder[0]->id}}">{{$newOrder[0]->number}}</a>.
                                </p>
                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="pe-3 pe-sm-5 pb-3 pb-sm-0 border-right-light">
                                        ...
                                        <span class="mb-2 font-weight-bold">{{ trans('message.client_name')}}</span>
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="pe-3 pe-sm-5 pb-3 pb-sm-0 border-right-light">
                                        ...
                                        <span class="mb-2 font-weight-bold">{{ trans('message.email')}}:</span>
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="pe-3 pe-sm-5 pb-3 pb-sm-0 border-right-light">
                                        ...
                                        <span class="mb-2 font-weight-bold">{{ trans('message.mobile')}}:</span>
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="pe-3 pe-sm-5 pb-3 pb-sm-0 border-right-light">
                                        ...
                                        <span class="mb-2 font-weight-bold">{{ trans('message.address')}}:</span>
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="pe-3 pe-sm-5 pb-3 pb-sm-0 border-right-light">
                                        ...
                                        <span class="mb-2 font-weight-bold">{{ trans('message.country')}}:</span>
                                    </div>
                                </div>
                ...
                <div class="tab-pane tab-pane-navigation" id="cloud" role="tabpanel">
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="col-5">
                            ...
                            <div class="text-end">
                                ...
                                <span class="font-weight-normal text-4">{{ trans('message.plan_expiry')}} <strong class="font-weight-bold">{!! getDateHtml($subscription->ends_at) !!}</strong> </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                                ...
                                <div class="card-body p-relative zindex-1 p-3">
                                    ...
                                    <div class="feature-box feature-box-style-6 text-center d-block">
                                        ...
                                        <div class="feature-box-info">
                                            ...
                                            <h4 class="text-4 mt-3 mb-2 text-color-grey">{{ trans('message.change_cloud_domain')}}</h4>

                                            <p class="mb-2"><strong class="text-black text-2">{{ trans('message.current_domain_name')}}</strong> {{$installation_path}}</p>

                                            <p class="mb-0 text-2">{{ trans('message.click_customising_domain')}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-relative zindex-1 p-3">
                                    ...
                                    <div class="feature-box feature-box-style-6 text-center d-block">
                                        ...
                                        <div class="feature-box-info">
                                            ...
                                            <h4 class="text-4 mt-3 mb-2 text-color-grey">{{ trans('message.increase_decrease_agents')}}</h4>

                                            <p class="mb-2"><strong class="text-black text-2">{{ trans('message.current_no_agents')}} </strong>{{$latestAgents}}</p>

                                            <p class="mb-0 text-2">{{ trans('message.update_agent_count')}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body p-relative zindex-1 p-3">
                                        ...
                                        <div class="feature-box feature-box-style-6 text-center d-block">
                                            ...
                                            <div class="feature-box-info">
                                                ...
                                                <h4 class="text-4 mt-3 mb-2 text-color-grey">{{ trans('message.upgrade_downgrade_cloud')}}</h4>

                                                <p class="mb-2"><strong class="text-black text-2">{{ trans('message.current_plan')}}</strong> {{$planName}}</p>

                                                <p class="mb-0 text-2">{{ trans('message.change_cloud_plan')}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @else
                            <h6 class="mb-1"><i>{{ trans('message.current_plan')}} {{$planName}}</i></h6>
                        @endif
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="pe-3 pe-sm-5 pb-3 pb-sm-0 border-right-light">
                                        ...
                                        <span class="mb-2 font-weight-bold">{{ trans('message.auto_renewal')}}:</span>
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="pe-3 pe-sm-5 pb-3 pb-sm-0 border-right-light">
                                        ...
                                        <span class="mb-2 font-weight-bold">{{ trans('message.status')}}:</span>
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="pe-3 pe-sm-5 pb-3 pb-sm-0 border-right-light">
                                        ...
                                        <span class="mb-2 font-weight-bold">{{ trans('message.payment_gateway')}}</span>
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="pe-3 pe-sm-5 pb-3 pb-sm-0 border-right-light">
                                        ...
                                        <span class="mb-2 font-weight-bold">{{ trans('message.subscription_enabled_date')}}</span>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="autorenewModalLabel">{{ trans('message.auto_renewal')}}</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            ...
                            <label class="form-label">{{ trans('message.select_payment')}} <span class="text-danger"> *</span></label>

                            <div class="custom-select-1">
                                <select class="form-select form-control h-auto py-2" data-msg-required="{{ trans('message.please_select_city')}}" name="city" required>
                                    <option value="">{{ trans('message.select')}}</option>
                                    <option value="1">{{ trans('message.razorpay')}}</option>
                                    <option value="2">{{ trans('message.stripe')}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">{{ trans('message.close')}}</button>

                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">{{ trans('message.save')}}</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="cloudDomainModalLabel">{{ trans('message.change_cloud_domain')}}</h4>
                ...
                <div class="modal-body">
                    ...
                    <p>{{ trans('message.wish_domain_purchase')}} <a href="https://store.ladybirdwebhost.com/" target="_blank">{{ trans('message.click_here')}}.</a>{{ trans('message.cname_cloud')}} <a href="https://docs.faveohelpdesk.com/docs/helper/cname/" target="_blank">{{ trans('message.learn_more')}}.</a></p>

                    <p class="text-black"><strong>{{ trans('message.current_cloud_domain')}}</strong> {{$installation_path}}</p>

                    <div class="row">

                        <div class="form-group col">

                            <label class="form-label">{{ trans('message.enter_domain_new_name')}} <span class="text-danger"> *</span></label>
                            ...
                            $(document).ready(function() {
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        $('#clouduserdomainfill').html('{!! trans('message.current_cloud_domain') !!} <a href="' + data.data + '">' + data.data + '</a>');
                                    },
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="changeDomain" class="btn btn-primary"><i class="fas fa-globe"></i> {{ trans('message.chg_domain')}}</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="numberOfAgentsModalLabel">{{ trans('message.change_no_of_agents')}}</h4>
                ...
                <div class="modal-body">
                    ...
                    <p class="text-black"><strong>{{ trans('message.current_no_agents')}}</strong> {{$latestAgents}}</p>

                    <p class="text-black"><strong>{{ trans('message.price_per_agent')}} </strong>{!! currencyFormat($ExistingPlanPirce,getCurrencyForClient(\Auth::user()->country),true) !!}</p>

                    <div class="row">


                        <label class="text-black"><strong>{{ trans('message.choose_no_desired_agents') }}</strong> <span class="text-danger">*</span></label>
                        ...
                        <div class="col-12">
                            <p class="text-black" id="pricetopaid" style="display: none;"><strong>{{ trans('message.price_to_be_paid') }}</strong> <span id="pricetopay" class="pricetopay"></span></p>
                        </div>
                        <div class="overlay" style="display: none;"></div> <!-- Add this line -->
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="agentNumber"><i class="fas fa-users"></i> {{ trans('message.update_agents')}}</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="cloudPlanModalLabel">{{ trans('message.upgrade_downgrade_cloud_plan')}}</h4>
                ...
                <div class="modal-body">
                    ...
                    <p class="text-black"><strong>{{ trans('message.current_plan')}} </strong>{{$planNameReal}}</p>

                    <div class="row">

                        <div class="form-group col">

                            <label class="text-black"><strong>{{ trans('message.select_new_plan')}}</strong> <span class="text-danger"> *</span></label>
    ...
    ->attribute('onchange', 'getPrice(this.value)') !!}
                        ...
                        <p class="text-black" id="upgrade1" style="display: none;" ><strong>{{ trans('message.total_credits_remaining')}} </strong><span id="priceOldPlan" class="priceOldPlan"></span></p>

                        <p class="text-black" id="upgrade2" style="display: none;" ><strong>{{ trans('message.price_for_new_plan')}} </strong><span id="priceNewPlan" class="priceNewPlan"></span></p>

                        <p class="text-black" id="upgrade2" style="display: none;" ><strong>{{ trans('message.price_to_be_paid')}} </strong><span id="priceToPay" class="priceToPay" ></span></p>
                        <div class="overlay" style="display: none;"></div> <!-- Add this line -->
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="upgradedowngrade"><i class="fas fa-cloud-upload-alt"></i> {{ trans('message.change_plan')}}</button>
                    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                        ...
                        <div class="form-group col">
                            ...
                            <div class="custom-select-1">
                                <select name="" id="sel-payment" class="form-control">
                                    <option value="" disabled>{{ trans('message.choose_your_option') }}</option>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-light"  onclick="refreshPage()" data-bs-dismiss="modal">{{ trans('message.close')}}</button>

                    <button type="button" id="payment"  class="btn btn-primary" data-bs-dismiss="modal">{{ trans('message.save')}}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="stripe-Modal" data-keyboard="false" data-backdrop="static" aria-hidden="true" >
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="defaultModalLabel" style="white-space: nowrap;">{{ trans('message.enter_card_details') }}</h4>
                        ...
                        <form id="payment-form" class="mx-auto" style="max-width: 500px;">
                            <div class="form-group row">
                                <div class="col-md-12 alert alert-info">
                                    {{ trans('message.card_secure')}} {{currencyFormat(1,getCurrencyForClient(\Auth::user()->country))}}, {{ trans('message.automatically_reverse')}}
                                </div>
                            </div>
        ...
        <div class="modal fade" id="confirmStripe" data-keyboard="false" data-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="autorenewModalLabel">{{ trans('message.payment_confirmation')}}</h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <input class="hidden" id="orderID" value={{$id}}>
                            <p style="color: #333;">{{ trans('message.refresh_process')}} <strong style="font-weight: bold;">{{ trans('message.finish')}}</strong> {{ trans('message.to_complete_payment')}}</p>
                            </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" id="confirmStripePayment" class="btn btn-primary" data-bs-dismiss="modal">{{ trans('message.finish')}}</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
            ...
            if ($(this).prop("checked")) {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        $('#alertMessage-2').show();
                        var result = '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><strong><i class="fa fa-check"></i> ' + @json(trans('message.success')) + '! </strong>' + response.message + '.</div>';
        ...
        function cardUpdate() {
            ...
            $('#payment').on('click', function () {
                ...
                if (pay == null) {
                    $("#payment").html("<i class='fa fa-check'></i> {{ trans('message.validate') }}");
                    $('#payerr').show();
                    $('#payerr').html(@json(trans('message.select_pay')));
                    $('#payerr').focus();
                ...
                if (pay == 'stripe') {
                    ...
                    $('#pay').on('click', async function () {
                        ...
                        $('#pay').html("<i class='fa fa-circle-o-notch fa-spin fa-1x'></i> " + @json( trans('message.processing')));
                        ...
                        await $.ajax({
                            ...
                            error: function (data) {
                                ...
                                var html = '<div class="alert alert-danger alert-dismissable alert-content"><strong><i class="fas fa-exclamation-triangle"></i>{{ trans('message.oh_snap') }} </strong>' + data.responseJSON.error + ' <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><br><ul>';
                                $('#error-1').show();
    ...
    <script type="text/javascript">
            ...
            if ($('#domainRes').val() == 1) {
                    ...
                    $.ajax ({
                        ...
                        success: function (data) {
                            if (data.message =='success'){
                                var result = '<div class="alert alert-success alert-dismissable"><strong><i class="fa fa-check"></i> ' + @json(trans('message.success')) + '! </strong> ' + data.update + ' <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>';
                ...
                $("#licenseSave").on('click',function(){
                    ...
                    if (pattern.test($('#newDomain').val()) || ip_pattern.test($('#newDomain').val())) {
                        ...
                        $('#domaincheck').show();
                        $('#domaincheck').html(@json(trans('message.enter_domain_form')));
                        $('#domaincheck').focus();
                    ...
                    $.ajax ({
                        ...
                        success: function (data) {
                            if (data.message =='success'){
                                var result =  '<div class="alert alert-success alert-dismissable"><strong><i class="far fa-thumbs-up"></i> {{ trans('message.well_done')}} </strong> '+data.update+' <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>';
        ...
        $(document).ready(function() {
            $('#changeDomain').on('click', function() {
                ...
                $('#changeDomain').html("<i class='fa fa-circle-o-notch fa-spin fa-1x fa-fw'></i> " + @json(trans('message.please_wait')));
                $('.loader-wrapper').show();
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success ==true){
                            var result = '<div class="alert alert-success alert-dismissable"><strong><i class="far fa-thumbs-up"></i> ' + @json(trans('message.well_done')) + ' </strong> ' + data.message + '</div>';
                            $('#success-domain').html(result).css('color', 'green').show();
                            $('#changeDomain').attr('disabled',false);
                            $('#changeDomain').html("<i class='fa fa-globe'>&nbsp;&nbsp;</i>" + @json(trans('message.chg_domain')));
                            $('.loader-wrapper').hide();
                        ...
                        if (data.responseJSON.success === false) {
                            var result = '<div class="alert alert-danger alert-dismissable"><strong><i class="far fa-thumbs-down"></i>' + @json( trans('message.error_oops')) + '</strong> ' + data.responseJSON.message + ' </div>';
        ...
        $(document).ready(function() {
            $('#agentNumber').on('click', function() {
                ...
                $('#agentNumber').html("<i class='fa fa-circle-o-notch fa-spin fa-1x fa-fw'></i> " + @json(trans('message.please_wait')));
                $('.loader-wrapper').show();
                $('.overlay').show(); // Show the overlay
                $('.modal-body').css('pointer-events', 'none');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#agentNumber').html("<i class='fa fa-users'>&nbsp;&nbsp;</i> " + @json(trans('message.update_agents')));
                        $('.loader-wrapper').hide();
                        $('.overlay').hide(); // Hide the overlay
                        $('.modal-body').css('pointer-events', 'auto');
                        window.location.href = response;
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#upgradedowngrade').on('click', function() {
                ...
                $('#upgradedowngrade').html("<i class='fa fa-circle-o-notch fa-spin fa-1x fa-fw'></i> " + @json(trans('message.please_wait')));
                $('.loader-wrapper').show();
                $('.overlay').show(); // Show the overlay
                $('.modal-body').css('pointer-events', 'none');
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success ==true){
                            ...
                            var result = '<div class="alert alert-success alert-dismissable"><strong><i class="far fa-thumbs-up"></i> ' + @json(trans('message.well_done')) + ' </strong> ' + data.message + ' <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>';
                            $('#response-upgrade').html(result);
                            $('#response-upgrade').css('color', 'green');
                            $('#upgradedowngrade').attr('disabled',false);
                            $('#upgradedowngrade').html("<i class='fas fa-cloud-upload-alt'>&nbsp;&nbsp;</i>{{ trans('message.change_plan')}}");
                            $('.loader-wrapper').hide();
                            $('.overlay').hide(); // Hide the overlay
                            $('.modal-body').css('pointer-events', 'auto');
                        }
        ...
        $.ajax({
            ...
            success: function(response) {
               ...
               error: function(xhr, status, error) {
                   var errorMessage = {!! json_encode(trans('message.something_different_payment')) !!};
                $('#confirmStripe').modal('hide');
                $('html, body').animate({ scrollTop: 0 }, 500);
                var html = '<div class="alert alert-danger alert-dismissable alert-content"><strong><i class="fas fa-exclamation-triangle"></i> {{ trans('message.oh_snap') }} </strong>' + errorMessage + ' <br><ul>';
                $('#error-1').show();
                document.getElementById('error-1').innerHTML = html;
                setTimeout(function() {
                    window.location.href = newUrl; 
