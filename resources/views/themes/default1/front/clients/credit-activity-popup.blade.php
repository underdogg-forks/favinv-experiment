<a data-id="{{$paymentId}}" href="#credit" class="btn btn-sm btn-secondary btn-xs open-createtenancyDialog" data-toggle="tooltip" title="{{ trans('message.credit_activity')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ trans('message.credit_balance_history')}}</h5>
            ...
            <div class="modal-body">
                <ul class="list-group">
                    ...
                    @endforeach
                    @else
                        <li class="list-group-item" style="text-align: center">{{ trans('message.no_activity_credit')}}</li>
                    @endif
                </ul>
            </div>
        </div>
