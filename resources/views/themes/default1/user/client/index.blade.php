            ...
            <div class="card card-secondary card-outline collapsed-card">
                ...
                <div class="card-body" id="advance-search" style="display:none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 form-group">
                            <!-- first name -->
                            {!! html()->label( __('message.industries'), 'industry') !!}<br>
                        ...
                        <div class="col-md-3 form-group">
                            <!-- first name -->
                            {!! html()->label( __('message.role'), 'role') !!}
                            {!! html()->select('role', ['' =>  __('message.choose')] + ['admin' => 'Admin', 'user' => 'User'], $request->role)
                                ->class('form-control')
                                ->id('role') !!}
                        </div>
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            {!! html()->select('position', ['' =>  __('message.choose')] + ['manager' => 'Sales Manager', 'account_manager' => 'Account Manager'], $request->position)
                                ->class('form-control')
                                ->id('position') !!}
                        </div>
                        ...
                        <div class="col-md-3 form-group">
                            <!-- first name -->
                            {!! html()->label( __('message.registered_till'), 'from') !!}
                        ...
                        <div class="col-md-3 form-group">
                            <!-- Email Status -->
                            {!! html()->label( __('message.email_status'), 'active') !!}
                            {!! html()->select('email_verified', ['' => __('message.choose')] + ['1' => 'Active', '0' => 'Inactive'], $request->email_verified)
                                ->class('form-control')
                                ->id('active') !!}
                        </div>
                        ...
                        <div class="col-md-3 form-group">
                            <!-- 2FA Status -->
                            {!! html()->label( __('message.2fa_status'), 'is_2fa_enabled') !!}
                            {!! html()->select('is_2fa_enabled', ['' => __('message.choose')] + ['1' => 'Enabled', '0' => 'Disabled'], $request->is_2fa_enabled)
                                ->class('form-control')
                                ->id('is_2fa_enabled') !!}
                        </div>
                    </div>
