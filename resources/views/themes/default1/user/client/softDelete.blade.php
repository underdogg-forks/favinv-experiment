...
@section('title')
    {{ trans('message.suspended_users') }}
@stop

@section('content-header')
    <div class="col-sm-6">
        <h1>{{ trans('message.suspended_users') }}</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="fa fa-dashboard"></i> {{ trans('message.home') }}</a></li>
            <li class="breadcrumb-item"><a href="{{url('clients')}}"><i class="fa fa-dashboard"></i> {{ trans('message.users') }}</a></li>
            <li class="breadcrumb-item active">{{ trans('message.suspended_users') }}</li>
        </ol>
    </div><!-- /.col -->
@stop
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <table id="deleted-user-table" class="table display " cellspacing="0" width="100%" styleClass="borderless">
                 <button  value="" class="btn btn-secondary btn-sm btn-alldell" id="bulk_delete"><i class= "fa fa-trash"></i>&nbsp;&nbsp;{{ trans('message.delete_permanently') }}</button><br /><br />
                    <thead><tr>
