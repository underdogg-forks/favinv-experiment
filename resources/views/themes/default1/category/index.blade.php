...
@section('content-header')
    <div class="col-sm-6">
        <h1>{{ trans('message.all_categories')}}</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="fa fa-dashboard"></i> {{ trans('message.home')}}</a></li>
            <li class="breadcrumb-item active">{{ trans('message.all_categories')}}</li>
        </ol>
    </div><!-- /.col -->
...
@section('content')
    ...
    <div class="card card-secondary card-outline">
        <div class="card-header">
            <h3 class="card-title">{{trans('message.category')}}</h3>
            <div id="response"></div>
            <div class="card-tools">
                <a href="#create-category" data-toggle="modal" data-target="#create-category" class="btn btn-default btn-sm pull-right"><span class="fa fa-plus"></span>&nbsp;&nbsp;{{trans('message.create')}}</a></h4>
